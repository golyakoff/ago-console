...
describe("the services dictionary screen", () => {
  ...
  it("adds a service and re-reads the configuration", async () => {
    calendarApi.getConfiguration.mockResolvedValueOnce(configuration).mockResolvedValueOnce({
      ...configuration,
      services: [...configuration.services, { serviceId: "s2", name: "Beard trim", durationMinutes: 20 }],
    });
    ...
    expect(calendarApi.createService).toHaveBeenCalledWith("token", { name: "Beard trim", durationMinutes: 20 });
