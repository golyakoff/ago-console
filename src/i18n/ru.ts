...
export const ru: ConsoleStrings = {
  ...
  installOriginPanelDescription:
    ...
    "в эфир.",
  installScriptNotReadyTitle: "Почти готово",
  installScriptNotReadyBody:
    "Мы ещё дорабатываем публичный адрес, с которого сам виджет будет загружаться. Как только это " +
    "будет готово, на этой странице появится небольшой фрагмент кода для вставки на ваш сайт - " +
    "делать что-то иначе по сравнению с тем, что показано здесь сегодня, не понадобится.",
  ...
  contactDetailsKindLabel: "Тип",
  contactDetailsValuePlaceholder: "Номер телефона, email или другие данные",
  contactDetailsRecordButton: "Записать",
  contactDetailsRecordingButton: "Запись…",
