...
export const en: ConsoleStrings = {
  ...
  emailChannelDescription: "Brand your reply email with your own company name and logo.",
  emailChannelForbidden: "You don't have permission to configure this site's branding.",
  emailChannelLoadError: "Could not load the branding settings. Try again.",
  emailChannelLoadingLabel: "Loading branding settings…",
  emailChannelPanelTitle: "Reply email branding",
  emailChannelCompanyNameFieldLabel: "Company name",
  emailChannelCompanyNameFieldDescription: "Shown in the reply email a visitor gets - falls back to your site's own name when left blank.",
  emailChannelSaveButton: "Save",
  emailChannelSavingButton: "Saving…",
  emailChannelSaveError: "Could not save the company name. Try again.",
  emailChannelSaveSuccess: "Saved.",
  emailChannelLogoFieldLabel: "Logo",
  emailChannelLogoFieldDescription: "A static PNG, JPEG, or GIF, 100x100 pixels or smaller.",
  emailChannelLogoPreviewAlt: "Current logo",
  emailChannelLogoUploadingButton: "Uploading…",
  emailChannelUploadError: "Could not upload the logo. Try again.",
  emailChannelLogoInvalidFormatClientError: "That file isn't a PNG, JPEG, or GIF image.",
  emailChannelLogoTooLargeClientError: "That file is too large - 200 KB or smaller.",
  emailChannelLogoInvalidDimensionsClientError: "That image is larger than 100x100 pixels.",
  emailChannelLogoStatusPending: "Checking…",
  emailChannelLogoStatusReady: "Live",
  emailChannelLogoStatusRejected: "Rejected",
  emailChannelLogoRejectedReasonPrefix: "Reason:",
  ...
  calendarPersonNameUnavailable: "name not shown yet",
  calendarPersonNameUnavailableTooltip: "This person's name is kept in chat and could not be reached right now. It will appear once chat is available again.",
