 ...
 *
 * Identical shape to `ago-widget/src/protocol/sequence.ts` - one tracker per open conversation (the
 * console only ever has one conversation open at a time in `5-07`'s scope, same as the widget's own
 * single visitor conversation).
 */
